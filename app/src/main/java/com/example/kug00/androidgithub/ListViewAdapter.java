...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 아이템 내 각 위젯에 데이터 반영
        txt1.setText(listViewItem.getHour());
        txt2.setText(listViewItem.getMinute());
        txt3.setText(listViewItem.getTodo());
        return convertView;
    }
    ...
    public void addItem(String hour, String minute, String todo) {
